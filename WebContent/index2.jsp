...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script type="text/javascript" src="<%=ctxindex%>/index2.js"></script>
...
<script type="text/javascript">
	...
	*/
	...
	var json = {"options":"[{\"mod\":\"meeting\",\"modname\":\"视频会议\"},{\"mod\":\"message\",\"modname\":\"短消息\"}]"} 

	//json = {"options":"[{\"mod\":\"sys\",\"modname\":\"系统管理\"}]"}

	//var json2 = {"options":"[{\"mod\":\"sys\",\"modname\":\"系统管理\"},{\"mod\":\"sys\",\"modname\":\"系统管理2\"},{\"mod\":\"sys\",\"modname\":\"系统管理3\"}]"}
</script>
</head>
<body>
...
<div class="ui-layout-west">
	<div class="ui-layout-north">
		<div class="header" style="">导航栏</div>
		<div class="content">
			<div id="accordion">
				<h3><a href='#'>系统管理</a></h3>
				<div>
				<ul><li><a href='#'>机构管理</a></li>
				<li><a href='#'>用户管理</a></li>
				<li><a href='#'>权限管理</a></li></ul>
				</div>
			</div>
		</div>
		</div>
	...
	<ul style="list-style-type:none;">
		<li title=""><a class="ui-helper-clearfix" rel="qinkun1234"
		href="javascript:void(0)"><img width="25"
		onerror="var d=this.getAttribute('defaultsrc');if(d &amp;&amp; this.src!=d)this.src=d;"
		defaultsrc="<%=ctxindex%>/images/im/noavatar_small.gif"
		src="<%=ctxindex%>/images/im/noavatar_small.gif"><strong>qinkun1234</strong><span>&nbsp;</span></a></li>
		<li title=""><a class="ui-helper-clearfix" rel="qinkun123"
		href="javascript:void(0)"><img width="25"
		onerror="var d=this.getAttribute('defaultsrc');if(d &amp;&amp; this.src!=d)this.src=d;"
		defaultsrc="<%=ctxindex%>/images/im/noavatar_small.gif"
		src="<%=ctxindex%>/images/im/noavatar_small.gif"><strong>qinkun1233</strong><span>&nbsp;</span></a></li>
	</ul>
	</div>
	</div>
		<!--  
		...
		<div id="main_01">
			...
			<div class="bh_an" style=""><a title="" href=""><img src="<%=ctxindex%>/js/webcall/image/bh_img.gif"></a></div>
		
		</div>
		
		<div class="bh_bh">
		<ul style="list-style:none;padding-left: 5px;">
		<li><a title="" href="#" style="padding-left: 0px;"><img src="<%=ctxindex%>/js/webcall/image/bh_1.gif"></a></li>
		<li><a title="" href="#" style="padding-left: 0px;"><img src="<%=ctxindex%>/js/webcall/image/bh_2.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_3.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_4.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_5.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_6.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_7.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_8.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_9.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_11.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_0.gif"></a></li>
		<li><a title="" href="#"><img src="<%=ctxindex%>/js/webcall/image/bh_22.gif"></a></li>
		</ul>
		</div>
		</div>
		</div>//WEST UI-LAYOUT-SOUTH
		-->
	</div>
...
<script>
	$(function() {
		...
		innerWestLayout.sizePane('north', 255);innerWestLayout.open('north');
